...
import com.blogspot.geekabyte.webmuncher.util.ElasticSearchAction;
...
/**
 * Integration test for {@link com.blogspot.geekabyte.webmuncher.util.ElasticSearchAction}
 *
...
public class ElasticSearchActionIntegrationTest {
    ...
    private static final String CLUSTER_NAME = "webmuncher_test";
    ...
    public void testElasticSearchAction() throws InterruptedException, IOException, URISyntaxException {
        ...
        Webmuncher webmuncherSUT = new Webmuncher(esAction);
